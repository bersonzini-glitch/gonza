...
const ADMIN_NAV = [
  ...
  { href: "/admin/surgeons", label: "Cola de cirujanos", icon: Users },
  { href: "/admin/events", label: "Eventos", icon: CalendarRange },
  { href: "/admin/audit-log", label: "Historial de auditoría", icon: ScrollText },
] as const;
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[220px_1fr]">
        <nav aria-label="Administración" className="flex gap-1 overflow-x-auto lg:flex-col">
          {ADMIN_NAV.map((item) => (
            <Link
              key={item.href}
              href={item.href}
